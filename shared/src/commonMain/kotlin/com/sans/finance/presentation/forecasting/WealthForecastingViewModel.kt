...
class WealthForecastingViewModel constructor(
    ...
    val state = combine(
        ...
        val monthStart = com.sans.finance.core.util.DateTimeUtils.getStartOfMonth(now)
        val nextMonthStart = com.sans.finance.core.util.DateTimeUtils.addMonths(monthStart, 1)
