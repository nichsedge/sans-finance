    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = {
                    Text(
                        if (viewModel.isEditMode) stringResource(Res.string.edit_transaction) else stringResource(
                            Res.string.add_transaction
        ...
        if (showDeleteDialog) {
            AlertDialog(
                ...
                text = {
                    Column {
                        Text(stringResource(Res.string.delete_confirmation_msg))
        ...
        Column(
            ...
            Row(
                ...
                OutlinedTextField(
                    ...
                    label = { Text(stringResource(Res.string.amount_spent)) },
            ...
            // Date Picker Field
            OutlinedTextField(
                value = com.sans.finance.core.util.DateTimeUtils.formatDate(viewModel.selectedDate),
                onValueChange = { },
            ...
            ExposedDropdownMenuBox(
                ...
                OutlinedTextField(
                    ...
                    label = { Text(stringResource(Res.string.what_did_you_buy)) },
                    modifier = Modifier
                        .fillMaxWidth(),
                    singleLine = true,
                    keyboardOptions = KeyboardOptions(
            ...
            Text(
                stringResource(Res.string.category).uppercase(),
            ...
            ExposedDropdownMenuBox(
                ...
                OutlinedTextField(
                    ...
                    label = { Text(stringResource(Res.string.merchant_store)) },
                    modifier = Modifier
                        .fillMaxWidth(),
                    singleLine = true,
                    keyboardOptions = KeyboardOptions(
            ...
            val paymentLabels = listOf(
                ...
                stringResource(Res.string.recurring_expenses),
                stringResource(Res.string.installment)
            )
            LazyRow(
                modifier = Modifier.fillMaxWidth(),
                horizontalArrangement = Arrangement.spacedBy(10.dp)
            ...
            if (viewModel.isInstallment) {
                OutlinedTextField(
                    ...
                    label = { Text(stringResource(Res.string.duration_months)) },
                    modifier = Modifier.fillMaxWidth(),
                    singleLine = true,
                    keyboardOptions = KeyboardOptions(
            ...
            Button(
                ...
                Text(
                    text = (if (viewModel.isEditMode) stringResource(Res.string.update_transaction) else stringResource(
                        Res.string.confirm_transaction
                    )).uppercase(),
