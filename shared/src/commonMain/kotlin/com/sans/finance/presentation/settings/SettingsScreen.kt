...
fun SettingsScreen(
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text(stringResource(Res.string.settings), style = MaterialTheme.typography.titleMedium, fontWeight = FontWeight.ExtraBold) },
                navigationIcon = {
                    if (onBack != null) {
        ...
        SettingsContent(
            ...
            exportBackup = { viewModel.performMaintenance() },
...
fun SettingsContent(
    ...
    LazyColumn(
        ...
        // Language Section
        item {
            SettingsSectionTitle(stringResource(Res.string.language))
            Card(
        ...
        item {
            ...
            Surface(
                ...
                Row(
                    ...
                    Spacer(Modifier.width(16.dp))
                    Column(modifier = Modifier.weight(1f)) {
                        Text(stringResource(Res.string.recurring_expenses))
                        Text(
        ...
        item {
            SettingsSectionTitle(stringResource(Res.string.data_management))
            Card(
                ...
                Row(
                    ...
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        ...
                        Column {
                            Text(
                                stringResource(Res.string.full_backup),
                                style = MaterialTheme.typography.bodyLarge,
                                color = MaterialTheme.colorScheme.onTertiaryContainer,
                                fontWeight = FontWeight.Bold
                            )
                            Text(
                                stringResource(Res.string.backup_to_downloads),
                                style = MaterialTheme.typography.bodySmall,
