...
fun AccountStatsScreen(
    onBack: () -> Unit,
    viewModel: AccountStatsViewModel = koinViewModel()
) {
            ...
            TopAppBar(
                title = {
                    Row(
                        ...
                        Text(stringResource(Res.string.account_stats), fontWeight = FontWeight.Black)
                        Row(
                            verticalAlignment = Alignment.CenterVertically,
                            ...
                            Text(
                                com.sans.finance.core.util.DateTimeUtils.formatMonthYear(state.selectedDate),
